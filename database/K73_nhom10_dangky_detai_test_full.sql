-- IMPORT GUIDE
-- 1. Create/select the target database in phpMyAdmin first.
-- 2. Import this file while that database is selected.
-- This avoids CREATE DATABASE permission errors on shared hosting.
...
-- ============================================================================
-- TEST SCENARIOS: DANG KY CUNG MOT DE TAI
-- Import this file as a complete database. Re-importing resets the whole schema.
-- Period #1 stays open until the end of November 2026.
--
-- Test accounts (all use password: sv123456):
--   testa01@k73.test  / SV021  - leader of TEST A
--   testb01@k73.test  / SV023  - leader of TEST B
--   testc01@k73.test  / SV025  - leader of TEST C (already registered)
--   testd01@k73.test  / SV027  - leader of TEST D
--
-- Scenario 1: TEST A and TEST B can both register TST01 because max_groups = 2.
-- Scenario 2: TEST C already reserves TST02. TEST D sees it as full because
--             TST02 has max_groups = 1.
-- Existing records above also demonstrate approved, rejected, cancelled,
-- revoked and pending registrations.
-- ============================================================================

UPDATE `registration_periods`
SET `group_start` = '2026-07-01 00:00:00',
    `group_end` = '2026-11-30 23:59:59',
    `register_start` = '2026-07-01 00:00:00',
    `register_end` = '2026-11-30 23:59:59',
    `status` = 'open'
WHERE `id` = 1;

INSERT INTO `users` (`id`, `name`, `email`, `password`, `role`, `user_code`, `phone`, `created_at`) VALUES
(25, 'Test A Leader', 'testa01@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV021', '0922000021', '2026-07-01 08:00:00'),
(26, 'Test A Member', 'testa02@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV022', '0922000022', '2026-07-01 08:00:00'),
(27, 'Test B Leader', 'testb01@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV023', '0922000023', '2026-07-01 08:00:00'),
(28, 'Test B Member', 'testb02@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV024', '0922000024', '2026-07-01 08:00:00'),
(29, 'Test C Leader', 'testc01@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV025', '0922000025', '2026-07-01 08:00:00'),
(30, 'Test C Member', 'testc02@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV026', '0922000026', '2026-07-01 08:00:00'),
(31, 'Test D Leader', 'testd01@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV027', '0922000027', '2026-07-01 08:00:00'),
(32, 'Test D Member', 'testd02@k73.test', '$2y$10$VxEVab.//0YFKu/fqxBx6ON8/68stmCEpyS/tgpgY7Sf0rZGaWhHu', 'student', 'SV028', '0922000028', '2026-07-01 08:00:00');

INSERT INTO `class_students` (`class_id`, `student_id`, `joined_at`) VALUES
(1, 25, '2026-07-01 08:05:00'), (1, 26, '2026-07-01 08:05:00'),
(1, 27, '2026-07-01 08:05:00'), (1, 28, '2026-07-01 08:05:00'),
(1, 29, '2026-07-01 08:05:00'), (1, 30, '2026-07-01 08:05:00'),
(1, 31, '2026-07-01 08:05:00'), (1, 32, '2026-07-01 08:05:00');

INSERT INTO `topics` (`id`, `teacher_id`, `code`, `title`, `description`, `min_members`, `max_members`, `created_at`) VALUES
(11, 2, 'TST01', 'Test: De tai cho hai nhom', 'De tai dung de kiem tra hai nhom cung dang ky. Cau hinh cho phep toi da hai nhom.', 2, 4, '2026-07-01 08:10:00'),
(12, 2, 'TST02', 'Test: De tai mot suat', 'De tai dung de kiem tra khi da du so nhom. Mot nhom da dat cho truoc.', 2, 4, '2026-07-01 08:10:00');

INSERT INTO `topic_classes` (`id`, `topic_id`, `class_id`, `registration_period_id`, `max_groups`, `status`, `assigned_at`) VALUES
(17, 11, 1, 1, 2, 'open', '2026-07-01 08:15:00'),
(18, 12, 1, 1, 1, 'open', '2026-07-01 08:15:00');

INSERT INTO `student_groups` (`id`, `class_id`, `registration_period_id`, `name`, `join_code`, `status`, `created_by`, `created_at`) VALUES
(9, 1, 1, 'TEST - Nhom A', 'TESTA26', 'forming', 25, '2026-07-01 08:20:00'),
(10, 1, 1, 'TEST - Nhom B', 'TESTB26', 'forming', 27, '2026-07-01 08:20:00'),
(11, 1, 1, 'TEST - Nhom C da giu suat', 'TESTC26', 'registered', 29, '2026-07-01 08:20:00'),
(12, 1, 1, 'TEST - Nhom D thu dang ky', 'TESTD26', 'forming', 31, '2026-07-01 08:20:00');

INSERT INTO `group_members` (`group_id`, `user_id`, `role`, `joined_at`) VALUES
(9, 25, 'leader', '2026-07-01 08:20:00'), (9, 26, 'member', '2026-07-01 08:20:00'),
(10, 27, 'leader', '2026-07-01 08:20:00'), (10, 28, 'member', '2026-07-01 08:20:00'),
(11, 29, 'leader', '2026-07-01 08:20:00'), (11, 30, 'member', '2026-07-01 08:20:00'),
(12, 31, 'leader', '2026-07-01 08:20:00'), (12, 32, 'member', '2026-07-01 08:20:00');

INSERT INTO `topic_registrations` (`id`, `group_id`, `topic_class_id`, `requested_by`, `status`, `teacher_feedback`, `reviewed_by`, `reviewed_at`, `created_at`, `active_group_id`) VALUES
(8, 11, 18, 29, 'pending', NULL, NULL, NULL, '2026-07-01 08:30:00', 11);

INSERT INTO `activity_logs` (`user_id`, `action`, `detail`, `created_at`) VALUES
(1, 'seed_test_scenarios', '[TEST-DKDT] Khoi tao du lieu test dang ky cung de tai', '2026-07-01 08:00:00'),
(29, 'register_topic', '[TEST-DKDT] Nhom C dang giu suat TST02', '2026-07-01 08:30:00');
